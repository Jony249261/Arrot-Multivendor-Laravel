                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <div class="icon-button-demo">
                                                    ...
                                                    @if($user->is_active)
                                                    <a href="{{ route('users.show',$user->id) }}" class="btn btn-danger waves-effect" style="float: left">
                                                        <i class="material-icons">visibility_off</i>
                                                    </a>
                                                    @else
                                                    <a href="{{ route('users.show',$user->id) }}" class="btn btn-success waves-effect" style="float: left">
