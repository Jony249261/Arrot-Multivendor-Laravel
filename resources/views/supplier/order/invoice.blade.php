...
@section('content')
    <section class="invoice">
        ...
        <div class="row no-print">
            <div class="col-xs-12">
                <a href="" target="_blank" onclick="myPrint()" class="btn btn-grad1 no-print pull-right"><i class="material-icons">local_printshop</i> Print</a>
                {{-- <button type="button" class="btn btn-grad1 pull-right"><i class="fa fa-credit-card"></i> Submit Payment
        </button>
